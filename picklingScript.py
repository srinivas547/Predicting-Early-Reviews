...
enc='cp437'
short_pos = open("positive.txt","r", encoding=enc).read()
short_neg = open("negative.txt","r", encoding=enc).read()
...
fset = open("featuresets.pickle", "wb")
...
LinearSVC_classifier = SklearnClasnsifier(LinearSVC())
